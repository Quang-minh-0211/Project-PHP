...
<head>
    ...
    <link rel="stylesheet" href="manager-permission-style.css">
</head>
        ...
        <div class="content">
            <div class="hero__container_1">
                <div class="hero__title">
                    <p><b>Thêm chức vụ</b></p>
                    <hr>
                </div>
                <form action="manager-bank.php" method="get">
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            <select name="select-permit" id="select-permit">
                                <option value="option-1">Root</option>
                                <option value="optine-2">Quản lý</option>
                                <option value="optione-2">Nhân viên</option>
                            </select>
                        </li>
                    </ul>
                    <div class="add-btn">
                        <button type="submit" class="add-button"><a href="">Thêm</a></button>
                    </div>
                </form>
            </div>
            <div class="hero__container_2">
                <div class="hero2-title">
                    <p><b>Danh sách chức vụ</b></p>
                </div>
            </div>
        </div>
    </main>
