...
<head>
    ...
    <link rel="stylesheet" href="manager-bank.css">
</head>
        ...
        <div class="content">
            <div class="hero__container_1">
                ...
                if (isset($_POST["add-bank"])) {
                    ...
                    $money = $_POST["money"];
                    $errors = array();
                    if (empty($nameCall) or empty($money)) {
                    ...
                    if (count($errors) > 0) {
                        ...
                        $sql = "INSERT INTO bank (nameCall, money) VALUES (?, ?)";
                        $stmt = mysqli_stmt_init($conn);
                        $prepareStmt = mysqli_stmt_prepare($stmt, $sql);
                        if ($prepareStmt) {
                            mysqli_stmt_bind_param($stmt, "si", $nameCall, $money);
                ...
                ?>
                <form action="manager-bank.php" method="post">
                    <ul>
                        <li>
                            <label id="label-1" for="nameCall">Tên gọi</label>
                            <input type="text" name="nameCall" id="nameCall">
                        </li>
                        <li>
                            <label id="label-2" for="money">Tiền</label>
                            <input type="text" name="money" id="money">
                        </li>
                    </ul>
                    <div class="add-btn">
                        <button type="submit" name="add-bank" class="add-button">Thêm</button>
                    </div>
                </form>
                <script>
            ...
            <div class="hero__container_2">
                ...
                <div class="tabel-container">
                    ...
                    while ($row = mysqli_fetch_assoc($result_tabel)) {
                        ...
                        echo "<td>
                            <button class='delete-button' onclick='deleteBank(" . $row['id'] . ")'>Delete</button>
                            </td>";
                        echo "</tr>";
                    }
                    echo "</tabel>";
                ...
                <script>
                    function deleteBank(bankId) {
                        ...
                        if (confirmation) {
                            ...
                            xhr.open("GET", "delete-bank.php?id=" + bankId, true);
                            xhr.send();
                        }
                    }
                </script>
